...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TrendZY — AI Fashion Trend Intelligence" },
      { name: "description", content: "Real-time fashion trend clusters, momentum signals and a shoppable product triad — powered by AI." },
      { name: "author", content: "TrendZY" },
      { property: "og:title", content: "TrendZY — AI Fashion Trend Intelligence" },
      ...
      { name: "twitter:site", content: "@trendzy" },
    ],
    links: [
